...
class GoodsCategory(models.Model):
    ...
    desc = models.CharField(max_length=300, default="", verbose_name="类别描述", help_text="类别描述")  # 简单描述
    category_type = models.IntegerField(choices=CATEGORY_TYPE, verbose_name="类目级别", help_text="类目级别")
    parent_category = models.ForeignKey("self", null=True, blank=True, verbose_name="父类目级别",
                                        help_text="父类目级别", related_name="sub_cat", on_delete=models.CASCADE)
...
class GoodsCategoryBrand(models.Model):
    ...
    品牌名
    '''
    category = models.ForeignKey(GoodsCategory, null=True, related_name='brands', blank=True, verbose_name="商品类目", on_delete=models.CASCADE)
    name = models.CharField(default="", max_length=30, verbose_name="品牌名", help_text="品牌类别")
    desc = models.CharField(max_length=300, default="", verbose_name="品牌描述", help_text="品牌描述")  # 简单描述
